...
public class Functional {
	...
	public List<Integer> rightDigit(List<Integer> originalList) {
	...
	public List<Integer> doubling(List<Integer> originalList) {
		List<Integer> tempList = new ArrayList<>();
	...
	public List<String> noX(List<String> originalList) {
